...
MESSAGES = {
    ...
    "Next": "Sesudah",
    "No posts found.": "Tidak ada artikel yang ditemukan.",
    "Nothing found.": "Tidak ditemukan.",
    "Older posts": "Artikel lebih lama",
    "Original site": "Situs orisinal",
    "Posted:": "Ditulis oleh:",
    "Posts about %s": "Artikel tentang %s",
    "Posts by %s": "Artikel oleh %s",
    "Posts for year %s": "Artikel untuk tahun %s",
    "Posts for {month_day_year}": "Artikel untuk {month_day_year}",
    "Posts for {month_year}": "Artikel untuk {month_year}",
    "Previous post": "Sebelumnya",
    "Previous": "Sebelum",
